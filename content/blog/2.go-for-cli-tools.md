...
description: After shipping CLIs in Node, Python, and Rust, Go has become my default choice — and the reasons are more boring than you'd expect.
date: 2025-01-22
featured: true
seo:
  title: SEO Why I Write CLI Tools in Go
  description: SEO After shipping CLIs in Node, Python, and Rust, Go has become my default choice — and the reasons are more boring than you'd expect.
tags:
  - go
  - cli
  - tooling

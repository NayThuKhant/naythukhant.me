...
featured: true
seo:
  title: SEO Building a Space-Themed UI Without Burning the GPU
  description: SEO How I got animated starfields, neon glows, and particle effects running at 60 fps using canvas, CSS containment, and a few smart trade-offs.
description: How I got animated starfields, neon glows, and particle effects running at 60 fps using canvas, CSS containment, and a few smart trade-offs.
tags:
  - css
  - performance
  - animation
